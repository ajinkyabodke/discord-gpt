export default function Page() {
  return (
    <div className="flex h-screen bg-[#313338] text-white">
      <div className="flex w-60 flex-col border-r border-gray-700 bg-[#2b2d31] p-5">
      ...
      <div className="flex-grow overflow-auto p-8">
        <div className="mb-6 flex justify-between">
          ...
          <PanelTopCloseIcon className="h-6 w-6 cursor-pointer text-gray-500" />
        </div>
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-2 text-sm text-gray-500">
              ...
              thread per this interval, unless they have Manage Channel or
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <div className="text-sm text-gray-500">
                Users will need to confirm they are of over legal age to view in
                the content in this channel. Age-restricted channels are exempt
                from the explicit content filter.
              </div>
            </div>
